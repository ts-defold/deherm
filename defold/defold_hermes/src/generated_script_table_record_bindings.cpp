...
constexpr Operation kOperations[] = {
  {0, 0x3aac69fdu, "script:b2d.get_version", "b2d", "get_version", 0, 0, 0, 4},
  {1, 0xea93e5f3u, "script:image.get_astc_header", "image", "get_astc_header", 0, 1, 4, 6},
  {2, 0xf808b822u, "script:bullet3d.get_version", "bullet3d", "get_version", 1, 0, 10, 4},
};
