...
function renderLua(component) {
  ...
  lines.push("function init(self)", "    assert(defold_hermes.attachComponent(self, COMPONENT_ID, SCHEMA_FINGERPRINT, COMPONENT_CONTEXT, PROPERTY_SPECIALIZATIONS))");
