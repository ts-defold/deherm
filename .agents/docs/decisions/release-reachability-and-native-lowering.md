...
current catalog, 486 of 1,361 recipes are universal-ready from declaration
identity alone and 875 still need generated specialization. Record-layout
...
or address validation. Within the specialization-required group, 146
preferred specialized-adapter recipes still need a generated selected route
from the universal bridge. The remainder need
