...
const COLLISION_RESPONSE = builtins.hash("collision_response");
const ANIMATION_DONE = builtins.hash("animation_done");
...
export default defineComponent({
  ...
  onMessage(_self: RocketSelf, messageId: DefoldHash, message: CollisionResponse): void {
    if (messageId === COLLISION_RESPONSE) {
      ...
      msg.post("#sprite", "play_animation", { id: builtins.hash("explosion") });
