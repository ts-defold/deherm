...
export function renderHeader(selected) {
...
export function renderSource(selected) {
...
// Rendered from the report's own `included` inventory, so a reachability
// projection can re-render a pruned subset without a second spelling of the
// typed-native lane.
export function renderTypescript(selected) {
