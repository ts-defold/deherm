...
export const scriptPinnedInputs = Object.freeze([
  ...
  // The profile catalog is generated by a later step but is an input to the
  // script SDK/constant lowering step. Keep the committed catalog in the
  // clean-room seed so the ordered pipeline has the same prior revision.
