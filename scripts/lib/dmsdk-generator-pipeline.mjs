...
export const dmSdkPinnedInputs = Object.freeze([
  ...
  "packages/bindings/overrides/dmsdk-hash-state-bindings.json",
...
export const generatedDmSdkArtifacts = Object.freeze([
  ...
  "packages/bindings/generated/defold-dmsdk-hash-state-bindings.json",
  "defold/defold_hermes/include/defold_hermes/generated_dmsdk_hash_state.h",
  ...
  "defold/defold_hermes/include/defold_hermes/generated_dmsdk_arena_cstring.h",
...
export const dmSdkGenerationSteps = Object.freeze([
  ...
  Object.freeze({ runtime: "node", script: "scripts/generate-dmsdk-hash-state-bindings.mjs" }),
