...
const urls = {
  ...
  overrides: new URL("bindings/overrides/script-dynamic-value-bindings.json", root),
  report: new URL("bindings/generated/defold-script-dynamic-value-bindings.json", root),
